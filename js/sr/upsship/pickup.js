...
(function(n, t) {
    ...
    var i = "https://pick-ups.co.il",
        ...
        r;
    if (typeof jQuery == "undefined") try {
        r = document.createElement("script");
        r.type = "text/javascript";
        r.src = i + "/api/jquery-2.1.4.min.js";
        r.onload = s;
        document.getElementsByTagName("head")[0].appendChild(r);
        console.log("load custom 2.1.4 version of jquery...'")
    } catch (o) {
        console.log("Exception: " + o)
    } else console.log("using current version of jquery " + jQuery.fn.jquery), $jp = jQuery, u()
